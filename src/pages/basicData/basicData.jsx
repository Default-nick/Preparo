            ...
            <form className="editProfile">
                <div className="cardProfileSection">
                    ...
                    <div className="secondSection">
                        <svg id="profilePic" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 496 512" size="100" height="100" width="100" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="cardProfileSection">
                    ...
                    <div className="secondSection">
                        <span id="textEditProfile">Email <span class="redEmphasis">*</span></span>
                ...
                <div className="cardProfileSection">
                    ...
                    <div className="secondSection">
                        <span id="textEditProfile">Nome <span class="redEmphasis">*</span></span>
                        <input className="inputProfile" placeholder="Digite seu nome" required></input>
                        <span id="textEditProfile">Sobrenome <span class="redEmphasis">*</span></span>
                        <input className="inputProfile" placeholder="Digite seu sobrenome" required></input>
                        <span id="textEditProfile">Telefone <span class="redEmphasis">*</span></span>
                ...
                <div className="cardProfileSection">
                    ...
                    <div className="secondSection">
                        <span id="textEditProfile">Github <span class="redEmphasis">*</span></span>
                        <input className="inputProfile" placeholder="http://github.com/abcdefghi" required></input>
                        <span id="textEditProfile">Behance <span class="redEmphasis">*</span></span>
                        <input className="inputProfile" placeholder="http://www.behance.net/abcdefghi" required></input>
                        <span id="textEditProfile">Linkedin <span class="redEmphasis">*</span></span>
