        ...
        return(
            <section id="header">
                <div class="navMenu">
                    <div id="upIcon">
                        <a href="/">
                            <svg class="logoNavbar" width="54" height="53" viewBox="0 0 54 53" fill="none" xmlns="http://www.w3.org/2000/svg" >
                ...
                <div id="profileNotify">
                    <div onClick={showNotify} id="notify">
                        <svg width="25" height="24" class="MuiSvgIcon-root" color="rgb(201, 59, 89)" focusable="false" viewBox="0 0 24 24" aria-hidden="true" >
                ...
                <div id="modalProfile">
                    ...
                    <a href="/formProfile"><span class="modalProfileItem">Dados básicos</span></a>
                    <span class="modalProfileItem">Currículo</span>
                    <a href="/localization"><span class="modalProfileItem">Localização</span></a>
                    ...
                    <span class="modalProfileItem">Teste</span>
                    <span class="modalProfileItem">Experiências</span>
                    <span class="modalProfileItem">Premiações</span>
                    <span id="line"></span>
                    <span class="modalProfileItem">
