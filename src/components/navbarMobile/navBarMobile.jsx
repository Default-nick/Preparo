                ...
                <div class="botMenu">
                    ...
                    <div id="subscribeMobileButton">
                        <svg width="25" height="25" viewBox="0 0 25 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M8.25 1h8.5a1 1 0 011 1v9.333a1 1 0 01-1 1h-8.5a1 1 0 01-1-1V2a1 1 0 011-1z" stroke="currentColor" stroke-width="2">
                        </path>
                        </svg>
                            <span id="mobileIcoText">inscrições</span>
                    </div>
                    <div onClick={showNotify} id="mobileNotifyButton">
                        <svg class="MuiSvgIcon-root" width="25" height="25" color="gray" focusable="false" viewBox="0 0 24 24">
